...
export const uiText = {
  English: {
    ...
    aiRoundActive: "Practice session active",
  ...
  Marathi: {
    ...
    generatingQuestions: "प्रश्न तयार होत आहेत...",
...
const localizedTopics: Record<AppLanguage, Record<string, (typeof topicsData)[keyof typeof topicsData]>> = {
  ...
  Hindi: {
    "number-patterns": {
      ...
      title: "संख्या पैटर्न",
      theory: "🔍 क्या आपने 2, 4, 6, 8 जैसी संख्याएं देखकर सोचा है कि अगली संख्या क्या होगी? यही संख्या पैटर्न है!\n\n👉 संख्या पैटर्न ऐसी श्रृंखला होती है जो एक तय नियम का पालन करती है।\n👉 अगली संख्या निकालने के लिए पहले नियम पहचानो, फिर उसी नियम को आगे बढ़ाओ।\n\n💡 उदाहरण\n2, 4, 6, 8 → हर बार +2\n5, 10, 15, 20 → हर बार +5",
    ...
    percentage: {
      ...
      title: "प्रतिशत",
      theory: "🛍️ आपने '50% OFF' देखा होगा, वही प्रतिशत का सबसे आसान उदाहरण है।\n\n👉 प्रतिशत का मतलब है: 100 में से कितना हिस्सा।\n👉 इससे तुलना करना आसान हो जाता है, जैसे मार्क्स, छूट और डेटा।\n\n💡 उदाहरण\n50% = 100 में से 50\n80% अंक = 100 में से 80",
    ...
    "work-time": {
      ...
      title: "काम और समय",
      theory: "👷 अगर 1 व्यक्ति 10 दिन में काम करता है, तो 2 लोग वही काम कितनी जल्दी करेंगे?\n\n👉 काम और समय अध्याय में काम की गति (efficiency) और समय का संबंध समझते हैं।\n👉 ज्यादा लोग मिलकर काम करें तो समय कम लगता है।\n👉 कम लोग हों तो वही काम ज्यादा समय लेता है।\n\n💡 उदाहरण\n1 व्यक्ति → 10 दिन\n2 व्यक्ति → 5 दिन (लगभग)",
    ...
    "linear-equations": {
      ...
      title: "रैखिक समीकरण",
      theory: "📊 मान लो दो चीजें जुड़ी हुई हैं, जैसे मात्रा बढ़े तो कीमत भी बदले। यही संबंध रैखिक समीकरण से दिखता है।\n\n👉 रैखिक समीकरण में चर (x, y) की घात 1 होती है।\n👉 इसका ग्राफ सीधी रेखा देता है।\n👉 सामान्य रूप: ax + by = c\n\n💡 उदाहरण\n2x + y = 10",
    ...
    "simple-interest": {
      ...
      title: "साधारण ब्याज",
      theory: "💸 अगर आपने ₹1000 उधार दिए और बाद में ₹1100 मिले, तो अतिरिक्त ₹100 आपका ब्याज है।\n\n👉 साधारण ब्याज मूलधन (Principal), दर (Rate) और समय (Time) पर निकाला जाता है।\n👉 यह केवल मूल रकम पर लगता है, बढ़ी हुई रकम पर नहीं।\n\n💡 उदाहरण\n₹1000 पर 10% दर से 1 साल का ब्याज = ₹100",
    ...
    "profit-loss": {
      ...
      title: "लाभ और हानि",
      theory: "🛒 अगर आपने कोई चीज ₹100 में खरीदी और ₹120 में बेची, तो ₹20 का लाभ हुआ।\n\n👉 लाभ-हानि में खरीद मूल्य (CP) और विक्रय मूल्य (SP) की तुलना करते हैं।\n👉 SP > CP तो लाभ, और SP < CP तो हानि।\n\n💡 उदाहरण\nCP = ₹100, SP = ₹120 → लाभ = ₹20",
  ...
  Marathi: {
    "number-patterns": {
      ...topicsData["number-patterns"],
      title: "संख्या पॅटर्न",
      theory: "🔍 2, 4, 6, 8 अशा संख्या पाहून तुम्हाला पुढे काय येईल असा प्रश्न पडतो का? हाच संख्या पॅटर्न आहे!\n\n👉 संख्या पॅटर्न म्हणजे ठराविक नियमाने चालणारी संख्यांची मालिका.\n👉 पुढची संख्या शोधण्यासाठी आधी नियम ओळखा आणि तोच नियम पुढे लावा.\n\n💡 उदाहरण\n2, 4, 6, 8 → प्रत्येक वेळी +2\n5, 10, 15, 20 → प्रत्येक वेळी +5",
    ...
    percentage: {
      ...topicsData.percentage,
      title: "टक्केवारी",
      theory: "🛍️ '50% OFF' असे ऑफर बोर्ड तुम्ही पाहिले असतील, तीच टक्केवारीची सोपी कल्पना आहे.\n\n👉 टक्केवारी म्हणजे 100 मधील किती भाग.\n👉 मार्क्स, सवलत, डेटा तुलना यासाठी टक्केवारी खूप उपयोगी पडते.\n\n💡 उदाहरण\n50% = 100 मधून 50\n80% गुण = 100 मधून 80",
    ...
    "work-time": {
      ...topicsData["work-time"],
      title: "काम आणि वेळ",
      theory: "👷 जर 1 व्यक्तीला काम पूर्ण करायला 10 दिवस लागतात, तर 2 जणांना किती दिवस लागतील?\n\n👉 काम आणि वेळ या भागात कामाची गती (efficiency) आणि वेळ यांचा संबंध समजतो.\n👉 जास्त लोक मिळून काम केल्यास वेळ कमी लागतो.\n👉 कमी लोक असतील तर तेच काम जास्त वेळ घेते.\n\n💡 उदाहरण\n1 व्यक्ती → 10 दिवस\n2 व्यक्ती → 5 दिवस (अंदाजे)",
    ...
    "linear-equations": {
      ...topicsData["linear-equations"],
      title: "रेषीय समीकरणे",
      theory: "📊 दोन गोष्टींचा संबंध दाखवायचा असेल, जसे प्रमाण बदलले की किंमत बदलते, तेव्हा रेषीय समीकरण उपयोगी पडते.\n\n👉 रेषीय समीकरणात चल (x, y) यांचा घात 1 असतो.\n👉 त्याचा ग्राफ सरळ रेषा देतो.\n👉 सामान्य रूप: ax + by = c\n\n💡 उदाहरण\n2x + y = 10",
      formula: "मानक रूप: ax + b = c\ny = mx + c",
      examples: [
    ...
    "simple-interest": {
      ...topicsData["simple-interest"],
      title: "साधे व्याज",
      theory: "💸 तुम्ही ₹1000 दिले आणि परत ₹1100 मिळाले, तर जास्तीचे ₹100 हे व्याज आहे.\n\n👉 साधे व्याज मूळ रक्कम (Principal), दर (Rate) आणि वेळ (Time) यावर काढले जाते.\n👉 हे फक्त मूळ रकमेवरच लागू होते.\n\n💡 उदाहरण\n₹1000 वर 10% दराने 1 वर्षाचे व्याज = ₹100",
      formula: "SI = (P × R × T) / 100\nAmount = Principal + SI",
      examples: [
    ...
    "profit-loss": {
      ...topicsData["profit-loss"],
      title: "नफा आणि तोटा",
      theory: "🛒 तुम्ही वस्तू ₹100 ला घेतली आणि ₹120 ला विकली, तर ₹20 नफा झाला.\n\n👉 नफा-तोटा यात खरेदी किंमत (CP) आणि विक्री किंमत (SP) यांची तुलना केली जाते.\n👉 SP > CP असेल तर नफा, आणि SP < CP असेल तर तोटा.\n\n💡 उदाहरण\nCP = ₹100, SP = ₹120 → नफा = ₹20",
...
export function getLocalizedQuestion<T extends {
  ...
  if (!translated) {
    ...
    return {
      ...
      options: question.options.map((option) => localizeGeneratedQuestionText(option, language)),
      explanation: localizeGeneratedQuestionText(question.explanation, language),
    };
  }
